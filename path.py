...
is_aws = os.getenv("IS_AWS", "False") == "True"  # Environment variable to check if running on AWS
base_dir = Path("/home/ubuntu/project") if is_aws else Path("C:/Users/rahul/OneDrive/Desktop/final project csv")
...
file_paths = [base_dir / file_name for file_name in files]
...
if st.button("Predict Price"):
    ...
    st.write(f"Predicted Average Cost for Two People: ₹{predicted_cost:.2f}")
